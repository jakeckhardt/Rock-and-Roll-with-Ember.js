...
module('Unit | Model | Band', function(hooks) {
  ...
  test('#isGreatBand', function(assert) {
    ...
    assert.ok(pearlJam.isGreatBand, 'A band with two or more good songs is a great band');
    ...
    assert.notOk(stiltskin.isGreatBand, 'A band with less than two good songs is not a great band');
